...
class EMA(Module):
    ...
    def __init__(
        self,
        model: Module,
        ema_model: Module = None,           # if your model has lazylinears or other types of non-deepcopyable modules, you can pass in your own ema model
        beta = 0.9999,
        ...
        power = 2 / 3,
        min_value = 0.0,
        param_or_buffer_names_no_ema: str = set(),
        ignore_names: str = set(),
        ignore_startswith_names: str = set(),
