...
class D2ViTTransformer(Backbone):
    def __init__(self, cfg, input_shape):
        ...
        self.extractor = ViTExtractor( model_type='dino_vitb8', stride = 4, model = None, device = 'cuda')  # This is not nn.Module so the parameters are not recursively registered.
        ...
        if self.frozen_stages == 42: # magic number to train the extractor
    ...
    def forward(self, x):
        ...
        logger.info_once('DINO ViT B8/4  forward pass done')
