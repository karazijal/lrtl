...
class DAVIS(object):
    ...
    TASKS = ['semi-supervised', 'unsupervised', 'unsupervised-motion']
    ...
    def __init__(self, root, task='unsupervised', subset='val', sequences='all', resolution='480p', codalab=False):
        ...
        annotations_folder = 'Annotations' if task == 'semi-supervised' else "Annotations_unsupervised_Xie_et_al" if task=='unsupervised-motion' else 'Annotations_unsupervised'
